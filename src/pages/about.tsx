...
const MeDetails = (props: MeDetailsProps) => {
  return (
    <>
      <div
        className={[
          "w-6/12 sm:w-3/12 md:w-6/12 2xl:w-3/12 text-right md:text-right py-1 px-1.5 font-semibold",
          props.full && "w-full text-center pb-0 sm:w-3/12 sm:text-right md:w-full md:text-center 2xl:w-3/12 2xl:text-right"
        ]
          .filter(c => !!c)
          .join(" ")}>
        {props.name}:
