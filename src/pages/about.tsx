										...
										<g transform="translate(-200.55198,-393.96227)">
											<g transform="matrix(1.018827,0,0,-1.018827,170.5996,498.03288)" id="g3019">
												<path
													...
													id="path14"
												/>
												<path d="m 31.1516,37.709 31.0356,0 0,10.189 -19.8042,0 0,38.874 -11.2314,0 0,-49.063 z" fill="rgb(var(--LinkedIn))" id="path16" />
												<path
...
const MeDetails = (props: MeDetailsProps) => {
	return (
		<>
			<div
				className={[
					"py-1 px-1.5 text-theme-faded",
					props.full
						? "w-full text-center pb-0 sm:w-3/12 sm:text-right md:w-full md:text-center 2xl:w-3/12 2xl:text-right"
						: "w-6/12 sm:w-3/12 md:w-6/12 2xl:w-3/12 text-right md:text-right"
				]
					.filter(c => !!c)
					.join(" ")}>
				{props.name}:
			...
			<div
				className={[
					"py-1 px-1.5 font-robo-flex",
					props.full
						? "w-full text-center pt-0 sm:w-9/12 sm:text-left md:w-full md:text-center 2xl:w-9/12 2xl:text-left"
						: "w-6/12 sm:w-3/12 md:w-6/12 2xl:w-3/12 text-left md:text-left"
				]
					.filter(c => !!c)
					.join(" ")}>
				{props.value}
